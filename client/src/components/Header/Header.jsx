        ...
        <header className="bg-gradient-to-b from-gray-50 to-white text-primary-600 py-6 px-10 relative">
            <div className="flex justify-between items-center">
                <div className="flex items-center gap-2">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900">RepoAnalyzer</h1>
                </div>
                <nav className="hidden md:flex items-center gap-8">
                    ...
                    <a href="https://webcrumbs.cloud/placeholder" className="font-medium hover:text-primary-600 transition-colors">Documentation</a>
                    <a href="https://webcrumbs.cloud/placeholder" className="font-medium hover:text-primary-600 transition-colors">About</a>
                </nav>
